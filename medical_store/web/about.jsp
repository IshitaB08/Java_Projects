<%-- 
    Document   : about
    Created on : 25 Jul, 2019, 4:35:46 AM
    Author     : hp
--%>
			...
			<div class="container">
				<div class="banner_content text-left">
					...
					<div class="page_link">
						...
						<a href="about.html">Appointment</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-6 col-md-6 pt-60 pb-60">
					<div class="appointment-right">
							...
							<h3 class="pb-20 text-center mb-20">Book an Appointment</h3>
                                                        ...
                                                        <input type="text" class="form-control" name="nm" value="enter name" />
                                                        <p>
                                                            <a href="about.jsp">  <input type="submit" class="main_btn text-uppercase" name="submit" value="submit" /></a>
                                                        </p>
                                                             </form>
							...
							<input id="datepicker2" class="dates form-control" name="Adate" placeholder="Appointment Date" type="text">
							<textarea name="messege" class="" rows="5" placeholder="Message" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Message'"></textarea>
